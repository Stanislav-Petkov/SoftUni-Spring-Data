...
public class EntityManager<E> implements DbContext<E> {
    ...
    public Iterable<E> find(Class<E> table) throws InvocationTargetException, SQLException, InstantiationException, NoSuchMethodException, IllegalAccessException {
